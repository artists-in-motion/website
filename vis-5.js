(function startWhenAIMReady() {
  ...
  const Vis5 = (() => {
    ...
    function setMaterialOpacity(mesh, opacity) {
      ...
      materials.forEach((mat, index) => {
        mat.opacity =
          index === 4 ? opacity : opacity * CONFIG.CUBE_SIDE_OPACITY;
      });
    }
    ...
    function choosePatchSize() {
      ...
      if (r < CONFIG.IMAGE_PATCH_LARGE_BIAS + 0.3 && sizes.includes(2))
        return 2;
  ...
  `,
    ...
    function commitFloatingInstances() {
      ...
      const alphaAttr =
        floatingInstancedMesh.geometry.getAttribute("aInstanceAlpha");
