//console.log("Vis 3 - SAT 20th JUN v1");
(function startWhenAIMReady() {
  ...
  let CONFIG = {
    ...
    VISUAL_SCALE: 0.25, // Overall visual scale. Try 0.15 to 0.5.
    ...
    GRID_SIZE: 3, // Cubelets per side. 3 = classic Rubik cube.

    CUBELET_SIZE: 0.9, // Cubelet size. Try 0.6 to 1.4.
    CUBELET_GAP: 0.02, // Gap between cubelets. Try 0 to 0.08.

    BUILT_CUBE_SCALE: 1.0, // Final cube scale when assembled.

    SCRAMBLE_MOVE_COUNT: 5, // Number of scramble moves.
    SCRAMBLE_RANDOM: true, // Random scramble on each load.

    // =========================================================
    // RUBIK ORIENTATION
    // =========================================================

    RUBIK_ROT_X: 0.0, // Rubik cube X rotation.
    RUBIK_ROT_Y: 0.0, // Rubik cube Y rotation.
    RUBIK_ROT_Z: 0.0, // Rubik cube Z rotation.

    // =========================================================
    // FLOATING FIELD
    // =========================================================

    FLOAT_CUBE_COUNT: 1000, // Floating cube count.

    FLOAT_SPREAD_X: 26.5, // Field width.
    FLOAT_SPREAD_Y: 8.5, // Field height.
    FLOAT_SPREAD_Z: 9.5, // Field depth.

    FLOAT_CLEAR_RADIUS: 2.25, // Empty space around Rubik cube.

    FLOAT_MIN_SCALE: 0.005, // Smallest cube size.
    FLOAT_MAX_SCALE: 0.015, // Largest cube size.

    FLOAT_OPACITY: 1.0, // Global field opacity.

    FLOAT_NEAR_DISTANCE: 2.0, // White distance threshold.
    FLOAT_FAR_DISTANCE: 7.0, // Grey distance threshold.

    FLOAT_NEAR_COLOR: new THREE.Color(0xffffff), // Near colour.
    FLOAT_FAR_COLOR: new THREE.Color(0x666666), // Far colour.

    // =========================================================
    // BASE ROTATION
    // =========================================================

    DEFAULT_ROT_X: -0.82, // Base X tilt.
    DEFAULT_ROT_Y: -0.18, // Base Y turn.
    DEFAULT_ROT_Z: -0.08, // Base Z roll.

    // =========================================================
    // MOUSE ROTATION
    // =========================================================

    MOUSE_ROT_X: 0.18, // Mouse tilt strength.
    MOUSE_ROT_Y: 0.28, // Mouse turn strength.
    MOUSE_ROT_Z: 0.05, // Mouse roll strength.
    ...
    SCROLL_ROT_X: 0.25, // Scroll X rotation amount.
    SCROLL_ROT_Y: 1.2, // Scroll Y rotation amount.
    SCROLL_ROT_Z: 0.0, // Scroll Z rotation amount.

    ROT_SPEED_TI: 4.0, // TI rotation speed multiplier.
    ROT_SPEED_MS: 1.0, // MS rotation speed multiplier.
    ROT_SPEED_TO: 4.0, // TO rotation speed multiplier.
  ...
  const TRANSITION = {
    ...
    TI: 100, // Transition In length (vh).
    TO: 100, // Transition Out length (vh).

    // =========================================================
    // TI - GLOBAL FADE
    // =========================================================

    TI_CUBE_FADE_START: 0, // Fade starts.
    TI_CUBE_FADE_END: 18, // Fade complete.

    // =========================================================
    // TI - FLOATING FIELD
    // =========================================================

    TI_FLOAT_FROM_Y: -8.0, // Field start offset.
    TI_FLOAT_END: 80, // Field build complete.

    // =========================================================
    // TI - RUBIK BUILD
    // =========================================================

    TI_RUBIK_START: 0, // Build starts.
    TI_RUBIK_END: 100, // Build completes.

    TI_TOP_LAYER_FALL: 5.0, // Top layer fall distance.
    TI_MID_LAYER_FALL_MULT: 1.15, // Middle layer multiplier.
    TI_BOTTOM_LAYER_FALL_MULT: 1.45, // Bottom layer multiplier.

    TI_LAYER_FALL_VARIANCE: 0.25, // Random fall variation.
    TI_LAYER_STAGGER: 0.1, // Layer timing stagger.
    TI_LAYER_WAVE: 0.035, // Per-cube timing variation.

    TI_EASE_POWER: 1.1, // Build easing power.
    ...
    MS_SOLVE_START: 0, // Solve starts.
    MS_SOLVE_END: 50, // Solve completes.

    // =========================================================
    // MS - SCROLL ROTATION
    // =========================================================

    ROT_START: 0, // Scroll rotation starts.
    ROT_END: 100, // Scroll rotation reaches full amount.

    // =========================================================
    // TO - FLOAT FIELD MOVEMENT
    // =========================================================

    FLOAT_TO_PULL_STRENGTH: 0.35, // Pull towards targets.

    FLOAT_TO_MOVE_START: 0, // Movement start.
    FLOAT_TO_MOVE_END: 65, // Movement complete.

    // =========================================================
    // TO - TIMING
    // =========================================================

    TO_RUBIK_BREAK_START: 10, // Breakup starts.
    TO_RUBIK_MOVE_END: 50, // Breakup movement complete.

    TO_FADE_END: 100, // Fade complete.

    // =========================================================
    // TO - RUBIK DISPERSAL
    // =========================================================

    RUBIK_OUT_DISTANCE_MIN: 0.3, // Minimum dispersal.
    RUBIK_OUT_DISTANCE_MAX: 1.0, // Maximum dispersal.

    RUBIK_OUT_TANGENT_VARIANCE: 1.2, // Side drift amount.
    RUBIK_FIELD_Y_BIAS: 0.5, // Vertical variation.

    RUBIK_TO_STAGGER_MAX: 0.22, // Timing stagger.
    RUBIK_FIELD_ROT_VARIANCE: 1.2, // Random rotation.
  ...
  const Vis3 = (() => {
    ...
    function makeRubikFieldPosition(sourcePosition) {
      ...
      const distance = randomRange(
        TRANSITION.RUBIK_OUT_DISTANCE_MIN,
        TRANSITION.RUBIK_OUT_DISTANCE_MAX
      );
      ...
      target.addScaledVector(
        tempTangent,
        (Math.random() - 0.5) * TRANSITION.RUBIK_OUT_TANGENT_VARIANCE
      );
    ...
    function makeFieldQuaternion(baseQuaternion) {
      const randomRotation = new THREE.Euler(
        (Math.random() - 0.5) * TRANSITION.RUBIK_FIELD_ROT_VARIANCE,
        (Math.random() - 0.5) * TRANSITION.RUBIK_FIELD_ROT_VARIANCE,
        (Math.random() - 0.5) * TRANSITION.RUBIK_FIELD_ROT_VARIANCE
      );
    ...
    function generateScrambleMoves() {
      ...
      for (let i = 0; i < CONFIG.SCRAMBLE_MOVE_COUNT; i++) {
        ...
        do {
          ...
          lastMove &&
          move.axis === lastMove.axis &&
          move.layer === lastMove.layer
        );
    ...
    function makeFaceMaterials(x, y, z, grid, dark) {
      ...
      return [
        // RIGHT
        isRight
          ? makeMaterial(textures.right, grid - 1 - z, grid - 1 - y)
          : dark,
    ...
    function getLayerFall(layerIndex) {
      ...
      return (
        TRANSITION.TI_TOP_LAYER_FALL * multiplier +
        Math.random() * TRANSITION.TI_LAYER_FALL_VARIANCE
      );
    }
      ...
      for (let x = 0; x < grid; x++) {
        for (let y = 0; y < grid; y++) {
          for (let z = 0; z < grid; z++) {
            ...
            const builtPosition = new THREE.Vector3(
              x * spacing - offset,
              y * spacing - offset,
              z * spacing - offset
            );
            ...
            cubelet.userData.fieldPosition = makeRubikFieldPosition(
              builtPosition
            );
            cubelet.userData.fieldScale = makeFieldScale();
            cubelet.userData.fieldQuaternion = makeFieldQuaternion(
              cubelet.userData.builtQuaternion
            );
            cubelet.userData.toStagger =
              Math.random() * TRANSITION.RUBIK_TO_STAGGER_MAX;
    ...
    function captureScrambledState() {
      ...
      cubelets.forEach((cubelet) => {
        ...
        const layerIndex = Math.round(
          visualTopToBottom * (CONFIG.GRID_SIZE - 1)
        );
        ...
        const wave =
          ((scrambledPosition.x + scrambledPosition.z) / 6 + 0.5) *
          TRANSITION.TI_LAYER_WAVE;

        cubelet.userData.tiDelay =
          layerIndex * TRANSITION.TI_LAYER_STAGGER + wave;
        cubelet.userData.tiDuration = Math.max(
          0.3,
          1 - cubelet.userData.tiDelay
        );
      });
    }
  ...
  fullProgress = clamp01(localY / Math.max(sectionHeight, 1));
    ...
    function applyTransitionIn() {
      ...
      const rubikTimeline = mapRange(
        tiProgress,
        pct(TRANSITION.TI_RUBIK_START),
        pct(TRANSITION.TI_RUBIK_END),
        0,
        1
      );
      ...
      cubelets.forEach((cubelet) => {
        const delayed = clamp01(
          (rubikTimeline - cubelet.userData.tiDelay) /
            Math.max(cubelet.userData.tiDuration, 0.0001)
        );

        const t = easeInOutCubic(Math.pow(delayed, TRANSITION.TI_EASE_POWER));

        cubelet.position.lerpVectors(
          cubelet.userData.introPosition,
          cubelet.userData.scrambledPosition,
          t
        );
    ...
    function applyMainScroll() {
      const solveProgress = mapRange(
        msProgress,
        pct(TRANSITION.MS_SOLVE_START),
        pct(TRANSITION.MS_SOLVE_END),
        0,
        1
      );
    ...
    function applyTransitionOut() {
      const breakupProgress = mapRange(
        toProgress,
        pct(TRANSITION.TO_RUBIK_BREAK_START),
        1,
        0,
        1
      );

      const rubikRawMove = mapRange(
        breakupProgress,
        0,
        pct(TRANSITION.TO_RUBIK_MOVE_END),
        0,
        1
      );
      ...
      cubelets.forEach((cubelet) => {
        const delayed = clamp01(
          (rubikRawMove - cubelet.userData.toStagger) /
            Math.max(1 - cubelet.userData.toStagger, 0.0001)
        );

        const moveT = easeInOutCubic(
          Math.pow(delayed, TRANSITION.TI_EASE_POWER)
        );

        cubelet.position.lerpVectors(
          cubelet.userData.builtPosition,
          cubelet.userData.fieldPosition,
          moveT
        );

        cubelet.quaternion.slerpQuaternions(
          cubelet.userData.builtQuaternion,
          cubelet.userData.fieldQuaternion,
          moveT
        );

        const scale =
          CONFIG.BUILT_CUBE_SCALE +
          (cubelet.userData.fieldScale - CONFIG.BUILT_CUBE_SCALE) * moveT;
    ...
    function updateRotationAndTransform() {
      ...
      const tiMouseStrength = mapRange(
        tiProgress,
        pct(TRANSITION.TI_MOUSE_START),
        pct(TRANSITION.TI_MOUSE_END),
        0,
        1
      );
      ...
      const mouseStrength =
        tiProgress < 1 ? tiMouseStrength : 1 - toMouseReduction;
      ...
      const toExtraRotation =
        toProgress * Math.max(CONFIG.ROT_SPEED_TO - CONFIG.ROT_SPEED_MS, 0);
  ...
  return true;
      ...
      destroy() {
        ...
        cubelets.forEach((cubelet) => {
          ...
          const materials = Array.isArray(cubelet.material)
            ? cubelet.material
            : [cubelet.material];
